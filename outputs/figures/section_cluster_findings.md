...
Finally, we can look at the characteristics investigated above - ethnic diversity and population size - but this time concentrated on the outperformers and underperformers of each cluster.
...
We look here at the geographic differences in the out/under-performers and their different indicators. In Cluster 0, we see that both the under-performers are location in the East of England, they are Cambridgeshire and Central Bedfordshire, also next door to each other geographically. As mentioned above, the divide between the out-performers and under-performers is split along the typical drivers of school readiness, suggesting these are some of the contributers to the difference in scores.
...
![Difference between the indicators for outperforming and underperforming neighbourhoods.](png/cluster_4.png) {#fig:cluster_4_regions}

### _Cluster 5_

![Difference between the indicators for outperforming and underperforming neighbourhoods.](png/cluster_5.png) {#fig:cluster_5_regions}
